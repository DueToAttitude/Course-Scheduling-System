    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a onclick="setting();"><span class="fui-gear"></span></a></li>
                <li class="active"><a href="userCtrl?action=logout"><b>管理员</b> <%=loginName%></a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</div>
...
<!-- /navbar -->
<%
    ArrayList<CourseBean> courseList = new CourseDao().queryAll();
%>
<div class="container">
       ...
       <div class="row">
           <div class="col-md-3">
               <form role="form" action="showInfo">
                   ...
                   <div class="control-group">
                       ...
                       <input class="form-control" type="text" name="name" id="remark">
                   </div>
           ...
           <div class="col-md-7 col-md-offset-1">
               <table style="width:100%" class="table-striped table-hover text-center">
                   <thead><td>课程</td><td>操作</td></thead>
                   <%
                       for(CourseBean courseBean : courseList) {
                   %>
                   <tr>
                       <td><%=courseBean.getCourseName()%></td>
                       <td><a href="showInfo?action=delete&page=courseInfo&row=<%=courseBean.getIdCourse()%>"><span class="fui-trash"></span></a></td>
                   </tr>
                   <%
                       }
                   %>
