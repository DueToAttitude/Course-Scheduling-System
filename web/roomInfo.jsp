...
<!-- /navbar -->
<%
    ArrayList<RoomBean> roomList = new RoomDao().queryAll();
%>
<div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <form role="form" action="showInfo">
                    ...
                    <input type="hidden" name="page" value="roomInfo">
                </form>
            </div>
            <div class="col-md-7 col-md-offset-1">
                <table style="width:100%" class="table-striped table-hover text-center">
                    <thead><td>教室</td><td>操作</td></thead>
                    <%
                        for(RoomBean roomBean : roomList) {
                    %>
                    <tr>
                        <td><%=roomBean.getRoomName()%></td>
                        <td><a href="showInfo?action=delete&page=roomInfo&row=<%=roomBean.getIdRoom()%>"><span class="fui-trash"></span></a></td>
                    </tr>
                    <%
                        }
                    %>
