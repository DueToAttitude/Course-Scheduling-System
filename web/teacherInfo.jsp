...
<!-- /navbar -->
<%
    ArrayList<TeacherBean> teacherList = new TeacherDao().queryAll();
    ArrayList<CourseBean> courseBeanArrayList = new CourseDao().queryAll();
    //System.out.println(courseBeanArrayList.size());
%>
<div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <form role="form" action="showInfo">
                    ...
                    <div class="control-group">
                        <label for="job">教师职业</label><br>
                        <select style="color: inherit;border: 2px" class="btn btn-wide btn-block" name="job" id="job">
                            <%
                    ...
                    <input type="hidden" name="page" value="teacherInfo">
                </form>
            </div>
            <div class="col-md-7 col-md-offset-1">
                <table style="width:100%" class="table-striped table-hover text-center">
                    <thead><td>教师</td><td>职业</td><td>操作</td></thead>
                    <%
                        for(TeacherBean teacherBean : teacherList) {
                            int i = 0;
                    %>
                    <tr>
                        <td><%=teacherBean.getTeacherName()%></td>
                        <td><%=new CourseDao().courseName(teacherBean.getIdCourse())%></td>
                        <td><a href="showInfo?action=delete&page=teacherInfo&row=<%=teacherBean.getIdTeacher()%>"><span class="fui-trash"></span></a></td>
                    </tr>
                    <%
                        }
                    %>
