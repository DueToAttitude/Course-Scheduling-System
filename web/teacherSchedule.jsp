    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="main.jsp"><span class="fui-home"></span></a></li>
                <li class="dropdown">
...
<%
    ...
    if(idTeacher == null || "".equals(idTeacher)) {
        idTeacher = "0";
    }
...
<div class="container">
                ...
                <div style="margin-top: 2px" class="col-md-9">
                    <form style="margin:15px 0px 0px" name="group" id="groupSelect">
                        <div class="control-group">
                            <label for="selectTeacher">教师： </label>
                            <select data-toggle="select" style="background-color: inherit;border: 2px" class="select select-default select-sm" id="selectTeacher" name="idTeacher" onchange="formsubmit(this);">
                                <%
                                    if(idTeacher.equals("0")) {
                                %>
                                ...
                                <%
                                    ...
                                    for(TeacherBean teacherBean : teacherBeanArrayList) {
                                        if(idTeacher.equals(Integer.toString(teacherBean.getIdTeacher()))) {
                                %>
                ...
                <div style="margin:15px 0px 0px" class="col-md-3">
                    <script>
                        function exportExcel() {
                            $("table").table2excel({
                                name:"<%=new TeacherDao().teacherName(Integer.parseInt(idTeacher))%>",
                                filename:"<%=new TeacherDao().teacherName(Integer.parseInt(idTeacher))%>"
                            });
                        }
                    </script>
    ...
    <div class="jumbotron">
        ...
        <div class="row table">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>教师：<%=new TeacherDao().teacherName(teacherBean.getIdTeacher())%></p>
                </div>
            </div>
            <div class="row">
                                ...
                                <%
                                    for (ScheduleBean scheduleBean : scheduleBeanArrayList) {
                                        if(scheduleBean.getTime() == 5*i+j+1) {
                                            out.print(new CourseDao().courseName(scheduleBean.getIdCourse()) + "<br>" + new RoomDao().roomName(scheduleBean.getIdRoom()) +
        ...
        <%
            ...
            scheduleBeanArrayList = new ScheduleDao().queryByTeacher(idTeacher);
        %>
        <div class="row table">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>教师：<%=new TeacherDao().teacherName(Integer.parseInt(idTeacher))%></p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-lg-8 col-md-offset-2">
